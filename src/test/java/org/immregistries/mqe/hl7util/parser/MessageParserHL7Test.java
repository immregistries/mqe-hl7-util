...
//		System.out.println("Elapsed time for mapping a message: " + (stop - start) + " milliseconds");
	...
	public void testSsnMessageMask(){
		assertEquals("SsnStaticPositionTest1", mpp.maskSsnInMessage(SsnStaticPositionTest1), SsnStaticPositionExpectedTest1);
		assertEquals("SsnStaticPositionTest2", mpp.maskSsnInMessage(SsnStaticPositionTest2), SsnStaticPositionExpectedTest2);
		assertEquals("SsnStaticPositionTest3", mpp.maskSsnInMessage(SsnStaticPositionTest3), SsnStaticPositionExpectedTest3);
		assertEquals("SsnConditionalPositionTest1", mpp.maskSsnInMessage(SsnConditionalPositionTest1), SsnConditionalPositionExpectedTest1);
		assertEquals("SsnConditionalPositionTest2", mpp.maskSsnInMessage(SsnConditionalPositionTest2), SsnConditionalPositionExpectedTest2);
	}
}
