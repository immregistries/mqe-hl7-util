...
public class HL7PatientParserTester {
  ...
  public void testAddressParse() {
    MqePatient patient = pParser.getPatient(map);
    List<MqeAddress> pa = patient.getPatientAddressList();
  ...
  public void testPatientGuardianMeta() {
    ...
    assertEquals("NK1[1]-2[1].2.1", mfi.getHl7Location().toString());
