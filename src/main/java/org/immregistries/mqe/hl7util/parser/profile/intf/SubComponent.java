...
public class SubComponent implements HL7SubComponent {
  ...
  /* (non-Javadoc)
   * @see org.immregistries.mqe.hl7util.parser.profile.generated.HL7SubComponent#getDatatype()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.immregistries.mqe.hl7util.parser.profile.generated.HL7SubComponent#getName()
   */
  @Override
