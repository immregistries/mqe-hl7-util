...
public enum VxuField {
  ...
  PATIENT_GUARDIAN_ADDRESS_TYPE(PATIENT, "address type", CodesetType.ADDRESS_TYPE, "NK1-4.7"),
  PATIENT_GUARDIAN_ADDRESS_COUNTY(PATIENT, "guardian address county", null, "NK1-4.9"),
