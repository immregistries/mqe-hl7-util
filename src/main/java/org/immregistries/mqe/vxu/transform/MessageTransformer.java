//package org.immregistries.mqe.vxu.transform;
//
...
//    }
//
//    private void transformVaccinations(List<MqeVaccination> vaccinations) {
...
//        }
//
//        //This is where we build the derived values.
//
//    }
//
...
////				}
////			}
////		}//NOPE:  Decided we don't need to make this pick in the MQE code.
//    }
//
//    protected void transformNextOfKinData(MqeMessageReceived mr) {
//        List<MqeNextOfKin> kinList = mr.getNextOfKins();
//        for (MqeNextOfKin kin : kinList) {
////			1. Clean the address
