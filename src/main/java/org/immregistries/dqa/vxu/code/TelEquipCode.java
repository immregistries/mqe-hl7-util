...
enum TelEquipCode {
    PH ("PH", "Telephone"),
		...
		static {for (TelEquipCode tuc : TelEquipCode.values()) {codeMap.put(tuc.CODE, tuc);}}
		TelEquipCode(String code, String desc) {this.CODE = code;this.DESC = desc;}
		public static TelEquipCode get(String code) {return codeMap.get(code);}
	}