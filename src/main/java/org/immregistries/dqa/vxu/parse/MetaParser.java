...
//    public List<MetaFieldInfo> mapValues(VxuField... vxuField) {
//        List<MetaFieldInfo> mfiList = new ArrayList<>();
//        for (VxuField field : vxuField) {
//            mfiList.add(mapFieldWhere(field));
//        }
//        return mfiList;
//    }
    ...
    public MetaFieldInfo mapValue(int absoluteSegmentIndex, VxuField vxuField) {
        ...
        Hl7Location hl7Location = new Hl7Location(vxuField.getHl7Locator(), absoluteSegmentIndex + 1, positionId);
        String value = this.getValue( hl7Location);
        return new MetaFieldInfo(value, vxuField, positionId, absoluteSegmentIndex);
    }

//    public MetaFieldInfo mapFieldWhere(VxuField vxuField) {
//        Hl7Location hl7Location = new Hl7Location(vxuField.getHl7Locator());
//        hl7Location.setSegmentSequence(this.positionId);
//        hl7Location.setLine(this.absoluteSegmentIndex + 1);
//        String value = this.getValue( hl7Location);
//        return new MetaFieldInfo(value, vxuField, this.positionId, this.absoluteSegmentIndex);
//    }
    ...
    public MetaFieldInfo mapValueForTypes(int absoluteSegmentIndex, VxuField vxuField, String selectHL7Ref, String... searchForCodeTypes) {
    ...
    MetaFieldInfo mapFieldWhere(int absoluteSegmentIndex, VxuField vxuField, String selectHL7Ref, String searchForCodeType) {
    ...
    public List<MetaFieldInfo> mapFirstWhereSegmentHas(String location, List<String> searchCodes, VxuField... fields) {
        List<MetaFieldInfo> metaFieldInfoList = new ArrayList<>();
        //Find segment...
        ...
        List<Integer> segs = map.getIndexesForSegmentName(location.substring(0,3));
        for (Integer i : segs) {
            //find rel code:
            String value = this.getValue(this.getLocationfor(location, i));

            if (searchCodes.contains(value)) {
                metaFieldInfoList.addAll(this.mapValues(i, fields));
                return metaFieldInfoList;
            }
        }
