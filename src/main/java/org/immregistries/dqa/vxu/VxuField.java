...
public enum VxuField {
	 ...
	 */
            ...
            , NEXT_OF_KIN_PHONE_TEL_USE_CODE("phone tel use code", CodesetType.TELECOMMUNICATION_USE, "NK1-5.2")
            , NEXT_OF_KIN_PHONE_TEL_EQUIP_CODE("phone tel equip code", CodesetType.TELECOMMUNICATION_EQUIPMENT, "NK1-5.3")
