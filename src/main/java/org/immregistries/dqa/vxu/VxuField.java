...
public enum VxuField {
  ...
  PATIENT_GUARDIAN_PHONE_TEL_USE_CODE("phone tel use code", CodesetType.TELECOMMUNICATION_USE, "NK1-5.2"),
  PATIENT_GUARDIAN_PHONE_TEL_EQUIP_CODE("phone tel equip code", CodesetType.TELECOMMUNICATION_EQUIPMENT, "NK1-5.3"),
