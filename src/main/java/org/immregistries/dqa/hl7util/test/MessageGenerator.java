...
public class MessageGenerator {
    ...
    public String getUniqueMessage() {
        ...
        final int currentMonth = dtCurrent.getMonthOfYear() + 1;
        ...
        String testMessageFormat = "MSH|^~\\&||1255-60-20|MCIR|MDCH|%d%d0301131228-0500||VXU^V04^VXU_V04|3WzJ-A.01.01.2aF|T|2.5.1|"
            + "\nPID|||3WzJ-A.01.01%s^^^AIRA-TEST^MR||%s^%s^^^^^L|%s^%s|%d%d01|%s||2076-8^Native Hawaiian or Other Pacific Islander^HL70005|81 Page Pl^^GR^MI^49544^USA^P||^PRN^PH^^^616^9245843|||||||||2135-2^Hispanic or Latino^HL70005|Birth Place PID-23|||"
            ...
            + "\nRXA|0|1|%d%d01||21^Varicella^CVX|0.5|mL^milliliters^UCUM||00^Administered^NIP001||||||Y5841RR||MSD^Merck and Co^MVX||||A|"
            ...
            + "\nRXA|0|1|%d%d01||00005-0100-01^Trumenba^NDC|0.5|mL^milliliters^UCUM||00^Administered^NIP001||||||N3783EO||PFR^Pfizer, Inc^MVX|||CP|A";
